 ...
 *  @param  num One of the PWM[0:15] output pins, or -1 so set all channels in one go.
 *  @param  on At what point in the 4096-part cycle to turn the PWM output ON
 *  @param  off At what point in the 4096-part cycle to turn the PWM output OFF
 *  @return result from endTransmission
 */
PCA9685::I2C_Result_e PCA9685::setPWM(int8_t num, uint16_t on, uint16_t off)
{
#ifdef PCA9685_DEBUG_ENABLED
    ...
    return (I2C_Result_e)_i2c->endTransmission();
}
 ...
 */
PCA9685::I2C_Result_e PCA9685::writeMicroseconds(uint8_t num, uint16_t Microseconds)
{
#ifdef PCA9685_DEBUG_ENABLED
    ...
    return (I2C_Result_e)setPWM(num, 0, pulse);
}
